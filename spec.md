...
- count urls visited per-domain. Ignore domain root
- block access when limit reached, display message
- reset limits every day
- when on a site in the limit list, display stats in UI
